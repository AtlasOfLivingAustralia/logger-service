...
//        logEventDao.save(entity1);        
    ...
    public void testTemplate() throws SQLException {
    	Collection<LogEvent> l = logEventDao.findLogEvents(1, 10);
    	
    	LogEvent event = logEventDao.findLogEventById(1);
    	System.out.println(event.toString());
    	
    	l = logEventDao.findLogEventsByEmail("dave.martin@csiro.au");
    	
    	l = logEventDao.findLogEventsByUserIp("127.0.0.1");
    	for(LogEvent e : l){
