...
<div class="container">
	...
	<ul>
		...
		<li><a href="${request.contextPath}/service/sourceBreakdown?eventId=1002&entityUid=in4" title="${jsonTitle}" class="tooltips"><strong>Source</strong> breakdown (last month, 3 month, 1 year, all)</a> <span class="file-type-icon json">json</span></li>
		...
		<li><a href="${request.contextPath}/service/emailBreakdownCSV?eventId=1002&entityUid=in4" title="${csvTitle}" class="tooltips"><strong>User category</strong> breakdown by month (all records)</a> <span class="file-type-icon csv">csv</span></li>
		<li><a href="${request.contextPath}/service/sourceBreakdownCSV?eventId=1002&entityUid=in4" title="${csvTitle}" class="tooltips"><strong>Source and reason</strong> breakdown by month (all records)</a> <span class="file-type-icon csv">csv</span></li>
	</ul>
</div>
</body>
</html>